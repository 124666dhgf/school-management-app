...
export default function About() {
    ...
    <div className="about">
      <h1 className="div1"><center>ABOUT MGM</center></h1>
    ...
    <div>
        ...
        <table>
            <tr className="hp">
                ...
                <h3> MGM History</h3>
                <p> It is established in 1902 and owned by "Catholicate & M.D Schools Corporate under the control of Malankara Orthodox Syrian Church'.
    ...
    <div>
          ...
          <center><img className="img" src={img1}></img></center>
    </div>
